...
exports.log = function (level) {
    ...
    if (logLevel <= levels[level]) {
        ...
        args[0] = args[0].replace(/<grey>(.*?)<\/grey>/i, '\u001b[90m$1\033[0m')
        args[0] = args[0].replace(/<red>(.*?)<\/red>/i, '\033[31m$1\033[0m')
        args[0] = args[0].replace(/<green>(.*?)<\/green>/i, '\033[32m$1\033[0m')
        args[0] = args[0].replace(/<yellow>(.*?)<\/yellow>/i, '\033[33m$1\033[0m')
        args[0] = args[0].replace(/<blue>(.*?)<\/blue>/i, '\033[34m$1\033[0m')
        args[0] = args[0].replace(/<purple>(.*?)<\/purple>/i, '\033[35m$1\033[0m')
        args[0] = args[0].replace(/<cyan>(.*?)<\/cyan>/i, '\033[36m$1\033[0m')
