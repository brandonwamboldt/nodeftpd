...
exports.start = function () {
    ...
    exports.server = net.createServer(function(socket) {
        ...
        logger.log('info', '[%s:%d] Client Connected', socket.remoteAddress, socket.remotePort);
        ...
        socket.on('data', function(data) {
            logger.log('info', '[%s:%d] Command received: %s', socket.remoteAddress, socket.remotePort, data.toString().trim());
